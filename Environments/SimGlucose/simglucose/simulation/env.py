...
class NS_T1DSimEnv(object):
    ...
    def step(self, action, reward_fun=neg_risk):
        ...
        self.all_BG.append(BG)
        self.all_CHO.append(CHO)
        self.all_insulin.append(insulin)
    ...
    def reset(self):
        ...
        # Interpolate between the two possible parameter configurations
        ...
        # plt.figure()
        # plt.plot(self.all_BG, label='BG')
        # plt.plot(self.all_CHO, label='CHO')
        # plt.plot(self.all_insulin, label='Insulin')
        # plt.legend()
        # plt.show()
