#!/bin/bash
#
#SBATCH --job-name=NS_2
#SBATCH --output=./stdoutput_2/NS_2_%A_%a.out # output file
#SBATCH --error=./stdoutput_2/NS_2.err        # File to which STDERR will be written
...
python ./run_parallel.py --inc $SLURM_ARRAY_TASK_ID --base 0 --hyper 0 --speed 2
