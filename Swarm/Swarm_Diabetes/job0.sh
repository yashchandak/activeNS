#!/bin/bash
#
#SBATCH --job-name=NS_0
#SBATCH --output=./stdoutput_0/NS_0_%A_%a.out # output file
#SBATCH --error=./stdoutput_0/NS_0.err        # File to which STDERR will be written
...
python ./run_parallel.py --inc $SLURM_ARRAY_TASK_ID --base 0 --hyper 0 --speed 0
