...
parser.add_argument("--speed", default=0, help="speed", type=int)
...
for seq in range(sequential):
    ...
    for par in range(parallel):
        my_array.append(('collectdata', args.inc*sequential*parallel + seq*parallel + par, args.hyper, args.base, args.speed))
