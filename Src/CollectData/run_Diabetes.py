...
class Parser(object):
    ...
    def Env_n_Agent_args(self, parser):
        ...
        parser.add_argument("--env_name", default='SimGlucosediscreteNS-v0', help="Environment to run the code")
    ...
    def Main_AC_args(self, parser):
        ...
        parser.add_argument("--actor_lr", default=5e-3, help="Learning rate of actor", type=float)
...
# @profile
def main(mode='train', inc=-1, hyper='default', base=-1, speed=-1):
    t = time()
