...
class Parser(object):
    ...
    def Env_n_Agent_args(self, parser):
        ...
        parser.add_argument("--env_name", default='MEDEVAC', help="Environment to run the code")
        parser.add_argument("--speed", default=2, help="Rate of nonstationarity", type=int)
    ...
    def Main_AC_args(self, parser):
        ...
        parser.add_argument("--critic_lr", default=5e-4, help="Learning rate of state features", type=float)
